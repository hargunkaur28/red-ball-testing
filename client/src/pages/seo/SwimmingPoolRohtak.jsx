...
const faqs = [
  {
    q: 'Is there a swimming pool at Red Ball Sports Arena in Rohtak?',
    a: 'Yes. Red Ball Sports Arena has a swimming pool in Rohtak, open year-round. Swimming sessions can be booked online or by walk-in.',
  },
  {
    q: 'Are swimming coaches available at Red Ball?',
    a: 'Yes. Swimming instructors are available for learn-to-swim lessons, technique improvement, and fitness swimming sessions.',
  },
  {
    q: 'Can children learn to swim at Red Ball Academy?',
  ...
  {
    q: 'How do I book a swimming slot at Red Ball Rohtak?',
...
export default function SwimmingPoolRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Swimming Pool in Rohtak | Red Ball Sports Arena Haryana"
        description="Red Ball Sports Arena has a swimming pool in Rohtak, Haryana. Open year-round with swimming instructors, kids lessons & membership plans. Book your swim session online."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Swimming · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Swimming Pool in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena offers a clean, well-maintained swimming pool in Rohtak, with trained instructors for all levels. From early morning laps to kids' learn-to-swim programs, the pool is available all week.
          </p>
      ...
      <section className="bg-[#F9F6F1] px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-[#0D0D0D] mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>More at Red Ball Sports Arena, Rohtak</h2>
          <div className="flex flex-wrap gap-3">
            {[
