...
const faqs = [
  ...
  },
  {
    ...
    a: 'Alchemy 360 offers professional coaching in cricket (including Box 360 circular format), badminton, pickleball, and swimming. All facilities are available for Jhajjar-based students.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Alchemy 360 has a dedicated Kids Sports Academy programme covering cricket, badminton, and swimming — ideal for children aged 6 and above travelling from Jhajjar.',
  },
];
  ...
  return (
    <SEOLandingLayout>
      <SEOHead
        ...
        description="Nearest sports academy to Jhajjar — Alchemy 360 Sports Arena in Rohtak, just 25 km and 25 minutes away. Cricket, badminton, pickleball, swimming coaching. Enrol today."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Alchemy 360 Sports Arena in Rohtak is the closest professional sports academy to Jhajjar — just 25 km away, roughly a 25-minute drive on Jhajjar Road. With facilities covering cricket, badminton, pickleball, and swimming, the short commute is more than worth it for serious athletes and young learners alike.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'All Major Sports Under One Roof', desc: 'Cricket (Box 360 circular format), badminton, pickleball, swimming, and gymnasium — all accessible with a single Alchemy 360 membership.' },
