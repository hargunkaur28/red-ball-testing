      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/sports/gym" className="border border-white/30 text-white font-bold px-6 py-3 rounded-full text-sm hover:border-white transition-colors" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              Book Day Pass
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {[
              ...
              { label: 'Memberships', to: '/buy-membership?sport=gym' },
            ].map(item => (
