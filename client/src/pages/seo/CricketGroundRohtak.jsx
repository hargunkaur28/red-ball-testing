...
const faqs = [
  {
    q: 'Where is Red Ball cricket ground located in Rohtak?',
    a: 'Red Ball Sports Arena cricket ground is located at Sector 22-D, Jhajjar Road, near Village Maina, Rohtak, Haryana 124001. It is easily accessible from the main Rohtak–Jhajjar highway.',
  },
  {
    q: 'Can I book the cricket ground online?',
    a: 'Yes. Red Ball offers online slot booking for the cricket ground. Visit the Book Slots page, select your preferred date and time, and complete the booking with online payment. QR-code entry is provided on booking.',
  },
  {
    q: 'What type of cricket is played at Red Ball?',
    a: 'Red Ball Sports Arena has a box cricket ground — a compact, enclosed format ideal for 6–11 players per side. It is fast-paced, can be finished in under an hour, and is perfect for both casual games and competitive tournaments.',
  },
  {
    q: 'Is the cricket ground available at night?',
    a: 'Yes. The cricket ground at Red Ball is fully floodlit and available for evening and night sessions. The facility is open from 5:00 AM to 11:00 PM daily.',
  },
  {
    q: 'Is the cricket ground available for tournaments?',
    a: 'Yes. Red Ball hosts private cricket tournaments, corporate cricket events, and the Rohtak Cricket League on its grounds. Contact us for tournament bookings.',
  },
  {
...
export default function CricketGroundRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Ground in Rohtak | Book Cricket Slot | Red Ball Sports Arena"
        description="Book the best cricket ground in Rohtak at Red Ball Sports Arena — professional pitch, floodlit box cricket ground, Sector 22-D Jhajjar Road. Online slot booking available."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket Ground · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Cricket Ground in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena features a dedicated, floodlit cricket ground in Rohtak — built for professional-quality play. Located on Jhajjar Road, Sector 22-D, it is the go-to cricket ground in Rohtak for private matches, practice sessions, league games, and tournaments.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
          Cricket Ground at Red Ball Sports Arena, Rohtak
        </h2>
