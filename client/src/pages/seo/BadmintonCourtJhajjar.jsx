...
const faqs = [
  {
    ...
    a: 'Yes. Red Ball Sports Arena in Rohtak is the nearest badminton facility to Jhajjar — just 25 km away on Jhajjar Road, Sector 22-D, and reachable in about 25 minutes.',
  },
  {
    q: 'How far is Red Ball Sports Arena from Jhajjar city?',
    a: 'Red Ball is approximately 25 km from Jhajjar, directly on the Rohtak–Jhajjar Road. Most Jhajjar residents make the drive in 20–25 minutes.',
  },
  {
    q: 'Can I book a badminton court online from Jhajjar?',
    a: 'Absolutely. You can book badminton court slots online at Red Ball Sports Arena from anywhere, including Jhajjar. Just pick your time slot and pay digitally — no need to visit in advance.',
  },
  {
    q: 'Does Red Ball have professional badminton courts?',
    a: 'Red Ball Sports Arena features well-maintained indoor badminton courts with proper court markings and equipment. The facility caters to casual players, club teams, and serious training sessions.',
  },
  {
    q: 'Is it worth driving from Jhajjar to Red Ball for badminton?',
    a: "For players serious about the sport, yes. Red Ball offers a standard of court and facility — including a restaurant on-site — that is not available in Jhajjar's immediate locality. The 25-minute drive is widely considered worthwhile by regular visitors from Jhajjar.",
  },
];
...
export default function BadmintonCourtJhajjar() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Badminton Court Near Jhajjar | Red Ball Sports Arena Rohtak"
        description="Nearest badminton court to Jhajjar — Red Ball Sports Arena, Rohtak, just 25 km / 25 minutes away. Professional courts, online booking, on-site restaurant."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Badminton · Near Jhajjar</p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Full Sports Day', desc: "Play badminton, then unwind with a swim in the open-air pool or a meal at Red Ball's on-site restaurant — all in one place." },
          ].map(item => (
