...
const faqs = [
  {
    q: 'What sports does Red Ball Sports Arena offer in Rohtak?',
    a: 'Red Ball Sports Arena offers box cricket, badminton, pickleball, swimming, gym & fitness training, and a dedicated kids sports academy in Rohtak, Haryana.',
  },
  {
  ...
  {
    q: 'Is there a kids sports academy at Red Ball?',
    a: 'Yes. Red Ball Academy runs a dedicated kids sports program for badminton and cricket, with structured coaching sessions and beginner-friendly batches.',
  },
  {
  ...
  {
    q: 'Where is Red Ball Sports Arena located in Rohtak?',
    a: 'We are located at Sector 22-D, Jhajjar Road, near Village-Maina, Rohtak, Haryana 124001.',
  },
  {
    q: 'What are the operating hours?',
    a: 'Red Ball Sports Arena is open 7 days a week, from 5:00 AM to 11:00 PM, to accommodate early-morning and evening sessions.',
  },
];
...
export default function SportsAcademyRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Sports Academy in Rohtak | Red Ball Sports Arena"
        description="Red Ball Sports Academy in Rohtak, Haryana offers professional coaching in cricket, badminton, pickleball, swimming & gym. Memberships, slot bookings & kids programs available."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena is Rohtak's multi-sport complex built for players of all ages. Train with expert coaches, book courts anytime, and choose membership plans that fit your schedule.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-6" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
          What We Offer at Red Ball Academy
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {[
            ...
            <Link key={item.sport} to={item.link} className="border border-black/10 rounded-xl p-5 hover:border-[#C8102E]/40 hover:shadow-sm transition-all group">
              <h3 className="font-bold text-[#0D0D0D] mb-2 group-hover:text-[#C8102E] transition-colors" style={{ fontFamily: "'DM Sans', sans-serif" }}>{item.sport}</h3>
      ...
      <section className="bg-[#F9F6F1] px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-6" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
            Why Choose Red Ball Sports Arena in Rohtak?
          </h2>
