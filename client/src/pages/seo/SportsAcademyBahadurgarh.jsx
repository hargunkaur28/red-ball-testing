...
const faqs = [
  ...
  },
  {
    ...
    a: 'Alchemy 360 offers structured coaching in cricket (including the unique Box 360 circular format), badminton, pickleball, and swimming. Batch timings are flexible to accommodate commuting students.',
  },
  {
  ...
  return (
    <SEOLandingLayout>
      <SEOHead
        ...
        description="Best sports academy near Bahadurgarh — Alchemy 360 Sports Arena Rohtak, 45 km / 40 minutes away. Cricket, badminton, pickleball, swimming. Join the academy today."
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Cricket + Racket Sports + Swimming', desc: 'From Box 360 circular cricket to badminton and pickleball courts to an open-air swimming pool — Alchemy 360 covers every major sport under one roof.' },
