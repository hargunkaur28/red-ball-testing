...
const faqs = [
  {
    ...
    a: 'Yes. Red Ball Sports Arena has dedicated pickleball courts in Rohtak. Pickleball is a growing sport in India and Red Ball is one of the few venues in Rohtak where you can play it.',
  },
  {
  ...
  {
    q: 'Can I rent pickleball equipment at Red Ball?',
...
export default function PickleballCourtRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Pickleball Court in Rohtak | Red Ball Sports Arena Haryana"
        description="Play pickleball in Rohtak at Red Ball Sports Arena. Dedicated pickleball courts available for booking. A growing sport now accessible right here in Rohtak, Haryana."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Pickleball · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Pickleball Court in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena has dedicated pickleball courts in Rohtak. Pickleball is one of the fastest-growing sports in India — and now you can play it right here without travelling far. Perfect for all ages and fitness levels.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-[#0D0D0D]/70 text-sm md:text-base leading-relaxed mb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          Pickleball combines the best elements of tennis, badminton, and table tennis. Played on a smaller court with a paddle and a perforated plastic ball, it's fast, social, and accessible. It's taking off across India — and Rohtak now has a proper venue for it at Red Ball Sports Arena.
        </p>
      ...
      <section className="bg-[#F9F6F1] px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-[#0D0D0D] mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>More Sports at Red Ball, Rohtak</h2>
          <div className="flex flex-wrap gap-3">
            {[
