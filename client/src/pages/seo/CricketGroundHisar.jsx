...
const faqs = [
  {
    ...
    a: 'Red Ball Sports Arena in Rohtak is the nearest professional cricket ground to Hisar — approximately 100 km away, around 100 minutes on NH-9. It includes both an open cricket ground and Box 360, a 24/7 circular box cricket ground.',
  },
  {
    q: 'How far is Red Ball Sports Arena from Hisar?',
    a: 'Red Ball is around 100 km from Hisar city, at Sector 22-D, Jhajjar Road, Rohtak. The drive is approximately 100 minutes on NH-9.',
  },
  {
    q: 'Is the drive from Hisar to Red Ball straightforward?',
    a: 'Yes. NH-9 connects Hisar and Rohtak directly — the drive is on a good road with no major diversions. Red Ball is at Sector 22-D, Jhajjar Road, easy to locate on arrival in Rohtak.',
  },
  {
  ...
  {
    q: 'What should Hisar teams plan for a full day at Red Ball?',
...
export default function CricketGroundHisar() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Ground Near Hisar | Red Ball Sports Arena Rohtak"
        description="Cricket ground near Hisar — Red Ball Sports Arena in Rohtak, ~100 km on NH-9, ~100 min drive. Open ground + Box 360 24/7 circular box cricket, online booking available."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket · Near Hisar</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Cricket Ground Near Hisar
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena in Rohtak is approximately 100 km from Hisar — around 100 minutes on NH-9. For Hisar cricket players and teams that want a professional setting with both traditional open ground and Box 360 circular box cricket, Red Ball is the most complete cricket destination in western Haryana.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Fuel Up Before You Leave', desc: "Red Ball's on-site restaurant ensures Hisar teams are well-fed before the 100-minute drive back on NH-9 — proper food, on-site, no side trips needed." },
          ].map(item => (
