...
const faqs = [
  {
    ...
    a: 'Yes. Red Ball Sports Arena in Rohtak is the nearest professional cricket ground to Jhajjar — just 15–20 minutes away on Jhajjar Road, Sector 22-D.',
  },
  {
    q: 'How far is Red Ball Sports Arena from Jhajjar?',
    a: 'Red Ball Sports Arena is approximately 15–20 km from Jhajjar city, easily reachable on the Rohtak–Jhajjar Road. The journey takes around 20–25 minutes.',
  },
  {
    q: 'Can teams from Jhajjar book the cricket ground?',
    a: 'Yes. Teams and players from Jhajjar regularly book Red Ball\'s cricket ground for matches, practice sessions, and tournaments. Online booking is available.',
  },
  {
    q: 'Is there parking available at the cricket ground for Jhajjar visitors?',
    a: 'Yes. Red Ball Sports Arena has ample parking space for players and visitors travelling from Jhajjar and surrounding areas.',
  },
  {
    q: 'Can Jhajjar corporate teams book the cricket ground for events?',
    a: 'Yes. Corporate cricket events and team-building sports days are regularly organised at Red Ball for companies from Jhajjar district.',
  },
  {
    q: 'Is there a cricket academy near Jhajjar?',
    a: 'Red Ball Cricket Academy in Rohtak is the closest professional cricket academy to Jhajjar, offering coaching, practice ground, and membership programs.',
  },
];
...
export default function CricketGroundJhajjar() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Ground Near Jhajjar | Red Ball Sports Arena Rohtak"
        description="Best cricket ground near Jhajjar — Red Ball Sports Arena in Rohtak, just 20 minutes from Jhajjar. Professional ground, floodlighting, online booking for Jhajjar teams."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket Ground · Near Jhajjar</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Cricket Ground Near Jhajjar
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena in Rohtak is the closest professional cricket ground to Jhajjar — located on Jhajjar Road, just 15–20 km and 20–25 minutes from Jhajjar city. Teams from Jhajjar book Red Ball for matches, practice sessions, tournaments, and corporate cricket events.
          </p>
