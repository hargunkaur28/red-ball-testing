...
const faqs = [
  {
    ...
    a: 'Yes. Alchemy 360 Sports Arena in Rohtak has Box 360 — Rohtak\'s first 24/7 circular box cricket ground. It is just 25 km and 25 minutes from Jhajjar on Jhajjar Road, making it the nearest box cricket venue to Jhajjar.',
  },
  {
  ...
  {
    q: 'Is Box 360 at Alchemy 360 open at night for Jhajjar visitors?',
  ...
  {
    q: 'Does Alchemy 360 have cricket tournaments that Jhajjar teams can participate in?',
    a: 'Yes. The Rohtak Cricket League (RCL) is hosted at Alchemy 360 and broadcast live on YouTube, Siti Cable, and DEN Networks. Teams from Jhajjar are eligible to participate and gain regional broadcast exposure.',
  },
];
...
export default function BoxCricketJhajjar() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Box Cricket Near Jhajjar | Box 360 at Alchemy 360 Sports Arena Rohtak"
        description="Box cricket near Jhajjar — Alchemy 360's Box 360, Rohtak's first 24/7 circular box cricket ground, just 25 km / 25 minutes from Jhajjar. Book your match today."
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'RCL Tournaments + Restaurant', desc: 'Compete in the Rohtak Cricket League — broadcast on YouTube, Siti Cable, and DEN. After the match, celebrate or commiserate at Alchemy 360\'s on-site restaurant before the drive back to Jhajjar.' },
          ].map(item => (
