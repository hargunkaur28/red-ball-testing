...
const faqs = [
  {
    ...
    a: 'Red Ball Sports Arena in Rohtak has a dedicated, covered box cricket ground at Sector 22-D, Jhajjar Road. Book your slot online or walk in.',
  },
  {
    q: 'How many players are needed for box cricket at Red Ball?',
  ...
  {
    q: 'How do I book the box cricket ground at Red Ball?',
...
export default function BoxCricketRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Box Cricket in Rohtak | Book Box Cricket Ground | Red Ball"
        description="Book box cricket in Rohtak at Red Ball Sports Arena. Covered, floodlit box cricket ground available for group matches, tournaments & corporate events. Easy online booking."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Box Cricket · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Box Cricket in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena has Rohtak's best box cricket experience — a covered, floodlit pitch designed for fast-paced, exciting cricket. Book it for a friendly game, a corporate outing, or a tournament.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
          Why Play Box Cricket at Red Ball?
        </h2>
        <p className="text-[#0D0D0D]/70 text-sm md:text-base leading-relaxed mb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          Box cricket at Red Ball Sports Arena is a proper, professional experience. Our enclosed ground means rain doesn't cancel your match. Floodlights mean you can play after sunset. And our easy online booking means your slot is confirmed before you arrive.
        </p>
      ...
      <section className="bg-[#F9F6F1] px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-[#0D0D0D] mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
            More at Red Ball Sports Arena, Rohtak
          </h2>
