...
const faqs = [
  {
    ...
    a: 'Alchemy 360 Sports Arena in Rohtak is the nearest professional cricket ground to Rewari — approximately 85 km away, around 80 minutes by road. It offers both an open cricket ground and Box 360, a 24/7 circular box cricket ground.',
  },
  {
    q: 'How far is Alchemy 360 Sports Arena from Rewari?',
    a: 'Alchemy 360 is around 85 km from Rewari, at Sector 22-D, Jhajjar Road, Rohtak. The drive is approximately 80 minutes.',
  },
  {
  ...
  {
    q: 'Is there parking for Rewari cricket teams at Alchemy 360?',
    a: 'Yes. Alchemy 360 Sports Arena has ample parking space for large groups and teams travelling from Rewari and surrounding areas.',
  },
];
...
export default function CricketGroundRewari() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Ground Near Rewari | Alchemy 360 Sports Arena Rohtak"
        description="Nearest cricket ground to Rewari — Alchemy 360 Sports Arena in Rohtak, ~85 km, ~80 min drive. Box 360 circular box cricket + open ground, online booking available."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C5DB3B] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket · Near Rewari</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Cricket Ground Near Rewari
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Alchemy 360 Sports Arena in Rohtak is approximately 85 km from Rewari — around 80 minutes by road. For Rewari cricket teams and players who want professional ground conditions, Alchemy 360 offers both an open cricket ground and Box 360, Rohtak's first 24/7 circular box cricket ground — bookable online, any time.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Cricket + Dining', desc: "After the match, Alchemy 360's on-site restaurant is right there. Rewari teams can eat together on-site before the drive back — no hunting for a dhaba on the highway." },
          ].map(item => (
