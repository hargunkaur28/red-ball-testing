...
const faqs = [
  {
    q: 'At what age can children start swimming classes at Alchemy 360?',
    a: 'Kids swimming classes at Alchemy 360 are available from age 4. The youngest children (4–6 years) are in specially designed beginner water comfort batches with child-specialist coaches.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. All children\'s swim coaches at Alchemy 360 are certified in both swimming instruction and child safety protocols including first aid and emergency response.',
  },
];
...
export default function KidsSwimmingClassesRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Kids Swimming Classes in Rohtak | Children's Swim Academy | Alchemy 360"
        description="Safe and fun kids swimming classes in Rohtak at Alchemy 360 Sports Arena — certified instructors, child-friendly pool, ages 4 and above. Enrol your child today."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C5DB3B] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Kids Swimming · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Kids Swimming Classes in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Alchemy 360 Sports Arena offers dedicated kids swimming classes in Rohtak — designed to build water confidence, safety awareness, and proper technique from an early age. Our certified instructors use child-friendly teaching methods that make learning to swim enjoyable and safe for children from 4 years old.
          </p>
