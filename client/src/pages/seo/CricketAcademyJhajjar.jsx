...
const faqs = [
  {
    ...
    a: 'Red Ball Sports Arena in Rohtak has the nearest professional cricket academy to Jhajjar — just 25 km and 25 minutes away on Jhajjar Road. Coaching covers all formats including the unique Box 360 circular cricket.',
  },
  {
    q: 'What makes Red Ball Cricket Academy stand out for Jhajjar players?',
    a: 'Red Ball is home to Box 360 — Rohtak\'s first 24/7 circular box cricket ground. The circular format develops unique fielding reflexes and batting angles not possible on conventional rectangular grounds. It\'s a training edge Jhajjar cricketers have started using.',
  },
  {
    q: 'Does Red Ball participate in any cricket tournaments?',
    a: 'Yes. Red Ball hosts the Rohtak Cricket League (RCL), which is broadcast live on YouTube, Siti Cable, and DEN Networks. Cricketers from Jhajjar can participate in league matches and gain competitive exposure on a broadcast platform.',
  },
  {
    q: 'Can I join the cricket academy at Red Ball as an adult from Jhajjar?',
    a: 'Absolutely. Red Ball\'s cricket academy has batches for juniors and adults. Whether you\'re starting out or looking to sharpen your game for competitive cricket, there\'s a programme suited to your level.',
  },
  {
    q: 'How do I book a cricket coaching slot at Red Ball from Jhajjar?',
...
export default function CricketAcademyJhajjar() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Academy Near Jhajjar | Red Ball Sports Arena Rohtak"
        description="Nearest cricket academy to Jhajjar — Red Ball Sports Arena Rohtak, 25 km / 25 minutes. Box 360 circular cricket, RCL league, professional coaching. Join the cricket academy."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket Academy · Near Jhajjar</p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Full Campus + Restaurant', desc: 'Cricket is just the start. After training, explore the badminton courts, swimming pool, or gymnasium — and end the session with a meal at Red Ball\'s on-site restaurant.' },
          ].map(item => (
