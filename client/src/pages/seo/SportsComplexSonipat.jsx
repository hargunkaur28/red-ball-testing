...
const faqs = [
  {
    ...
    a: 'Red Ball Sports Arena in Rohtak is the nearest comprehensive multi-sport complex to Sonipat — approximately 55 km away, around 55 minutes by road. It has cricket, badminton, pickleball, a swimming pool, a gym, and a restaurant.',
  },
  {
    q: 'How far is Red Ball Sports Arena from Sonipat?',
    a: 'Red Ball is around 55 km from Sonipat, at Sector 22-D, Jhajjar Road, Rohtak. The drive is approximately 55 minutes on the Rohtak–Sonipat Road.',
  },
  {
    q: 'Can Sonipat university students get memberships at Red Ball?',
  ...
  {
    q: 'Does Red Ball Sports Arena have badminton courts?',
    a: 'Yes. Red Ball has multiple badminton courts available for casual play, competitive matches, and coaching sessions — one of several sports available for Sonipat visitors.',
  },
  {
    q: 'What is Box 360 at Red Ball Sports Arena?',
    a: "Box 360 is Rohtak's first 24/7 circular box cricket ground — a unique format that runs at Red Ball Sports Arena around the clock. Sonipat cricket teams can book it for matches and tournaments at any time.",
  },
];
...
export default function SportsComplexSonipat() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Sports Complex Near Sonipat | Red Ball Sports Arena Rohtak"
        description="Sports complex near Sonipat — Red Ball Sports Arena in Rohtak, ~55 km, ~55 min drive. Cricket, badminton, pickleball, swimming, gym & on-site restaurant."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Sports Complex · Near Sonipat</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Sports Complex Near Sonipat
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena in Rohtak is approximately 55 km from Sonipat — around 55 minutes on the Rohtak–Sonipat Road. Sonipat players, students, and teams looking for a serious multi-sport facility will find everything at Red Ball that isn't locally available — including Box 360 circular box cricket, a professional swimming pool, and courts for badminton and pickleball.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
          Sonipat's Go-To Sports Complex — Red Ball in Rohtak
        </h2>
        <p className="text-[#0D0D0D]/70 text-sm md:text-base leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          Sonipat has a vibrant sports community — with multiple universities and a strong grassroots athletics culture. Red Ball Sports Arena in Rohtak gives Sonipat athletes the infrastructure to train at the level they're aiming for. The 55-minute drive on the Rohtak–Sonipat Road is straightforward, and arriving at Red Ball's Sector 22-D campus, you'll find sports courts, aquatic facilities, a gym, and coaching programs all waiting. It's not just a ground — it's a full sports day destination.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Full Day Out', desc: "Red Ball's on-site restaurant means Sonipat visitors can spend a full day — train in the morning, swim or play badminton in the afternoon, and eat before heading home." },
          ].map(item => (
