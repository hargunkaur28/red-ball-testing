...
const faqs = [
  {
    ...
    a: 'Alchemy 360 in Rohtak is the nearest comprehensive multi-sport complex to Sonipat — approximately 55 km away, around 55 minutes by road. It has badminton, pickleball, a gym, and a restaurant.',
  },
  {
  ...
  {
    q: 'Does Alchemy 360 have badminton courts?',
...
export default function SportsComplexSonipat() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Sports Complex Near Sonipat | Alchemy 360 Rohtak"
        description="Sports complex near Sonipat — Alchemy 360 in Rohtak, ~55 km, ~55 min drive. Badminton, pickleball, gym & on-site restaurant."
