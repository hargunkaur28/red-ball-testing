...
const faqs = [
  {
    ...
    a: 'Yes. Red Ball Sports Arena in Rohtak is the nearest professional cricket ground to Bahadurgarh — approximately 30–35 km away via NH 9, reachable in around 35–40 minutes.',
  },
  {
    q: 'How far is Red Ball Sports Arena from Bahadurgarh?',
    a: 'Red Ball Sports Arena is approximately 30–35 km from Bahadurgarh via Delhi–Rohtak NH 9. The drive takes around 35–40 minutes without traffic.',
  },
  {
    q: 'Can teams from Bahadurgarh book the cricket ground?',
    a: 'Yes. Teams and players from Bahadurgarh regularly book Red Ball\'s cricket ground. Online slot booking is available — book in advance and arrive ready to play.',
  },
  {
    q: 'Is Red Ball accessible from Bahadurgarh Industrial Area?',
    a: 'Yes. Bahadurgarh\'s industrial area is well-connected to Rohtak via NH 9. Many corporate teams from Bahadurgarh book Red Ball for cricket events.',
  },
  {
    q: 'Does Red Ball host corporate cricket events for Bahadurgarh companies?',
    a: 'Yes. Corporate cricket tournaments and sports days are a speciality at Red Ball. Companies from Bahadurgarh regularly organise cricket events at the facility.',
  },
  {
    q: 'Is there a cricket academy near Bahadurgarh?',
    a: 'Red Ball Cricket Academy in Rohtak is the closest professional cricket academy to Bahadurgarh with structured coaching, practice ground, and membership programs.',
  },
];
...
export default function CricketGroundBahadurgarh() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Ground Near Bahadurgarh | Red Ball Sports Arena Rohtak"
        description="Best cricket ground near Bahadurgarh — Red Ball Sports Arena in Rohtak, 35 minutes via NH 9. Professional floodlit ground, online booking, corporate cricket events."
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Full Sports Complex', desc: 'After cricket, enjoy badminton, swimming, gym, or the food court — making Red Ball a full sports day destination from Bahadurgarh.' },
          ].map(item => (
