...
const faqs = [
  {
    q: 'Does Red Ball Sports Arena host cricket tournaments in Rohtak?',
    a: 'Yes. Red Ball Sports Arena is Rohtak\'s premier cricket tournament venue — hosting the Rohtak Cricket League, corporate cricket events, inter-college tournaments, and private competitions.',
  },
  {
    q: 'How do I book Red Ball for a cricket tournament in Rohtak?',
    a: 'Contact Red Ball at +91 93500 76653 or email redballcricketground@gmail.com. Provide your tournament dates, number of teams, and format for a tournament package quote.',
  },
  {
    q: 'What formats are supported for cricket tournaments at Red Ball?',
    a: 'Red Ball supports box cricket, T10, T20, and custom match formats. The ground can accommodate tournaments with 4–20+ teams depending on the schedule.',
  },
  {
    q: 'Does Red Ball provide umpires and scorekeeping for tournaments?',
    a: 'Yes. Tournament packages at Red Ball include umpire arrangements, scorekeeping support, and tournament management services.',
  },
  {
    q: 'Is there food available for tournament teams at Red Ball?',
  ...
  {
    q: 'Can I organise an annual cricket tournament at Red Ball?',
    a: 'Yes. Many organisations use Red Ball as their annual cricket tournament venue. Early booking is recommended for preferred dates, especially weekends.',
  },
];
...
export default function CricketTournamentsRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Tournaments in Rohtak | Host Your Match | Red Ball Sports Arena"
        description="Red Ball Sports Arena is Rohtak's #1 cricket tournament venue — Rohtak Cricket League, corporate cricket, inter-college tournaments. Book your tournament today."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket Tournaments · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Cricket Tournaments in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena is Rohtak's home of cricket tournaments — hosting the Rohtak Cricket League, corporate cricket championships, inter-college competitions, and private tournaments. Professional infrastructure, digital entry, food court, and full event support make every tournament at Red Ball a memorable occasion.
          </p>
      ...
      <section className="bg-[#F9F6F1] px-4 py-10">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-xl font-bold text-[#0D0D0D] mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>Tournament Types at Red Ball</h2>
          <div className="flex flex-wrap gap-3">
            {[
