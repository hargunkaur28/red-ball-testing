...
export default function TermsAndConditions() {
  ...
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Terms and Conditions | Alchemy 360 Rohtak"
        description="Terms and Conditions for Alchemy 360, Rohtak, Haryana. Booking rules, membership terms, payments, cancellations & more."
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <Section title="About These Terms">
          <p>
            These Terms and Conditions govern your use of the Alchemy 360 website (<strong>alchemy360.in</strong>) and your access to all facilities and services operated by Alchemy 360 at Sector 22-D, Jhajjar Road, Rohtak, Haryana 124001.
          </p>
          <p>
        ...
        <Section title="Memberships and Subscriptions">
          <ul className="list-disc ml-5 space-y-2">
            ...
            <li>A registered account is required to purchase any membership. Memberships cannot be bought as a guest, because each membership is tied to the account used for QR entry, bookings and renewals.</li>
            <li>Only one active membership may be held per sport at a time. This applies across all plan types — single-sport, combo, court and coaching — so a plan covering a sport you already hold cover for cannot be purchased until the existing one expires or is cancelled.</li>
            <li>Memberships for a minor require a parent or guardian's consent and contact details.</li>
          </ul>
        </Section>
        ...
        <Section title="Facility Rules and Conduct">
          <ul className="list-disc ml-5 space-y-2">
            ...
            <li>Children must be accompanied and supervised by a parent or guardian unless enrolled in a supervised coaching session.</li>
            <li>Users are responsible for their personal belongings. Alchemy 360 is not liable for lost, stolen, or damaged property.</li>
        ...
        <Section title="Coaching Programs">
          <ul className="list-disc ml-5 space-y-2">
            <li>Coaching is currently offered for badminton. Enrollment requires accurate contact information, and for a minor, the details and consent of a parent or guardian.</li>
            <li>An admission fee may apply in addition to the membership fee. This is non-refundable once paid.</li>
            <li>Alchemy 360 reserves the right to place a participant in an appropriate age or skill batch, which may differ from the participant's preference.</li>
            <li>Photography or video of minors during coaching sessions requires express written permission from a parent or guardian.</li>
          </ul>
        </Section>
        ...
        <Section title="Court and Facility Availability">
          <ul className="list-disc ml-5 space-y-2">
            ...
            <li>Alchemy 360 reserves the right to close or restrict any area for maintenance, safety, or legal reasons.</li>
          </ul>
        </Section>
        ...
        <Section title="Health and Safety">
          <ul className="list-disc ml-5 space-y-2">
            ...
            <li>Alchemy 360 is not liable for injuries resulting from normal sporting activity, provided facility equipment is maintained in safe condition.</li>
          </ul>
        </Section>

        <Section title="Limitation of Liability">
          <p>
            To the maximum extent permitted by applicable law, Alchemy 360's liability for any claim arising out of your use of the facility or website is limited to the amount paid by you for the specific booking or service in question. We are not liable for indirect, consequential, or incidental damages.
          </p>
        </Section>
