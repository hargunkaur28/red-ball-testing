...
const faqs = [
  {
    q: 'Is Red Ball Sports Arena a full stadium in Rohtak?',
    a: 'Red Ball Sports Arena is a modern multi-sport complex in Rohtak with floodlit courts, a covered box cricket ground, swimming pool, gym, and sports facilities — comparable to a community sports stadium.',
  },
  {
    q: 'Can I rent the sports complex for tournaments or events?',
    a: 'Yes. Red Ball Sports Arena can host local tournaments, corporate sports events, and group bookings. Contact us to discuss event requirements.',
  },
  {
  ...
  {
    q: 'Where is Red Ball Sports Arena located?',
...
export default function StadiumInRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Stadium in Rohtak | Red Ball Sports Arena & Complex"
        description="Looking for a stadium or sports complex in Rohtak? Red Ball Sports Arena offers world-class facilities — box cricket, badminton, swimming, gym & pickleball. Book online today."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Multi-Sport Complex · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Stadium in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Sports Arena is Rohtak's premier sports complex — a full-featured venue with cricket grounds, racquet sports courts, aquatic facilities, and a modern gym, all under one roof.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            <Link key={item.title} to={item.link} className="border border-black/10 rounded-xl p-5 hover:border-[#C8102E]/40 hover:shadow-sm transition-all group">
              <h3 className="font-bold text-[#0D0D0D] mb-2 group-hover:text-[#C8102E] transition-colors" style={{ fontFamily: "'DM Sans', sans-serif" }}>{item.title}</h3>
      ...
      <section className="bg-[#F9F6F1] px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#0D0D0D]/70 text-sm md:text-base leading-relaxed mb-6" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Whether you're a casual player looking for a quick session, a serious athlete training daily, or a group organizing a corporate sports event — Red Ball Sports Arena in Rohtak is equipped to host you. Our facility supports individual bookings, membership-based access, and bulk team bookings.
          </p>
          <div className="flex flex-wrap gap-3">
            <Link to="/sports-academy-rohtak" className="text-[#C8102E] text-sm font-semibold hover:underline" style={{ fontFamily: "'DM Sans', sans-serif" }}>Sports Academy →</Link>
            <Link to="/sports-arena-rohtak" className="text-[#C8102E] text-sm font-semibold hover:underline" style={{ fontFamily: "'DM Sans', sans-serif" }}>Sports Arena →</Link>
            <Link to="/sports-complex-rohtak" className="text-[#C8102E] text-sm font-semibold hover:underline" style={{ fontFamily: "'DM Sans', sans-serif" }}>Sports Complex →</Link>
          </div>
        </div>
      </section>
