...
const faqs = [
  {
    ...
    a: 'Red Ball Sports Arena in Rohtak is the nearest full-scale professional cricket academy to Panipat — approximately 95 km and 90 minutes away. The quality of coaching and facilities makes the drive worthwhile for dedicated players.',
  },
  {
    q: 'What is Box 360 cricket at Red Ball?',
    a: 'Box 360 is Rohtak\'s first 24/7 circular box cricket ground at Red Ball Sports Arena. The circular format trains batsmen to score in all directions and sharpens fielding reflexes in ways traditional rectangular grounds cannot replicate.',
  },
  {
  ...
  {
    q: 'Is Red Ball Cricket Academy suitable for Panipat players who travel for coaching?',
    a: 'Yes. Red Ball accommodates travelling players with flexible batch timings including weekend programmes. Many serious cricketers from Panipat plan a weekly training trip, covering a full coaching session in a single visit.',
  },
  {
    q: 'How do I contact Red Ball Cricket Academy from Panipat?',
    a: 'Call +91 93500 76653 or book online. The Red Ball team will help you find the right batch and coaching programme to suit your skill level and travel schedule from Panipat.',
  },
];
...
export default function CricketAcademyPanipat() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Cricket Academy Near Panipat | Red Ball Sports Arena Rohtak"
        description="Professional cricket academy near Panipat — Red Ball Sports Arena Rohtak, 95 km / 90 minutes. Box 360 circular cricket, RCL league coverage. Join the cricket academy."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Cricket Academy · Near Panipat</p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { title: 'Play in the RCL — On Broadcast TV', desc: 'The Rohtak Cricket League is streamed live on YouTube and broadcast on Siti Cable and DEN Networks. Panipat cricketers who train and compete at Red Ball gain real media visibility.' },
            { title: 'Full Complex + Restaurant', desc: 'Recover from a hard training session with a visit to the swimming pool or gymnasium. Then eat well at Red Ball\'s on-site restaurant before the drive back to Panipat.' },
          ].map(item => (
