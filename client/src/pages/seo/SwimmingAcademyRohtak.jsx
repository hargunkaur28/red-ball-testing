...
const faqs = [
  {
    q: 'What makes Red Ball a swimming academy rather than just swim classes?',
    a: 'Red Ball Swimming Academy follows a structured curriculum with defined levels, milestone assessments, and progressive coaching — not just open pool time with basic instructions.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Red Ball\'s advanced swimming program is designed for competitive swimmers looking to improve race-level performance and stroke technique.',
  },
  {
    q: 'What is the coach-to-student ratio in swimming academy batches?',
    a: 'Red Ball maintains small batch sizes for quality coaching. The typical ratio is 1 coach to 6–8 students in structured academy batches.',
  },
];
...
export default function SwimmingAcademyRohtak() {
  return (
    <SEOLandingLayout>
      <SEOHead
        title="Swimming Academy in Rohtak | Professional Swim Training | Red Ball"
        description="Red Ball Swimming Academy in Rohtak — professional swim coaches, structured training programs from beginner to competitive level. Enrol now."
      ...
      <section className="bg-[#0D0D0D] text-white px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <p className="text-[#C8102E] text-sm font-semibold uppercase tracking-widest mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>Swimming Academy · Rohtak, Haryana</p>
          <h1 className="text-4xl md:text-6xl font-black mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '3px' }}>
            Swimming Academy in Rohtak
          </h1>
          <p className="text-white/70 text-base md:text-lg max-w-2xl leading-relaxed mb-8" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            Red Ball Swimming Academy is Rohtak's most complete swim training program — offering structured coaching from beginner water safety to competitive swimming preparation. Built on a progressive curriculum, certified coaches, and a technique-first approach.
          </p>
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D0D0D] mb-4" style={{ fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px' }}>
          Rohtak's Premier Swimming Academy at Red Ball Sports Arena
        </h2>
