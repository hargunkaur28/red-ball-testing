...
const TIMELINE = [
  { year: 'Founded', text: 'Red Ball Sports Arena was established by Sonu Malik with a vision to bring world-class multi-sport facilities to Rohtak, Haryana.' },
  ...
  { year: 'Expansion', text: 'Added badminton courts, swimming pool, gym, pickleball courts, and Box 360 — making Red Ball one of the most comprehensive private sports complexes in Haryana.' },
...
export default function About() {
  ...
  return (
    <>
      <SEOHead
        title="About Red Ball Sports Arena — Rohtak's Premier Multi-Sport Complex"
        description="Learn about Red Ball Sports Arena in Rohtak, Haryana — founded by Sonu Malik. Home of the Rohtak Cricket League. Cricket, badminton, swimming, pickleball, gym & kids academy."
        canonical="/about"
      />
      <Navbar />
      ...
      <section className="relative bg-[#0A0D0D] pt-28 pb-20 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/4 w-96 h-96 rounded-full blur-3xl opacity-10" style={{ background: '#C8102E' }} />
          <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full blur-3xl opacity-8" style={{ background: '#F5A623' }} />
        </div>
        <div className="max-w-5xl mx-auto px-4 sm:px-8 relative z-10">
          <FadeIn>
            <p className="text-[#C8102E] text-xs font-black uppercase tracking-[0.25em] mb-4">Rohtak, Haryana · Est. Red Ball Sports Arena</p>
            <h1
              className="text-white leading-none mb-6"
              style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 'clamp(3rem, 8vw, 6rem)', letterSpacing: '2px' }}
            >
              About Red Ball<br />Sports Arena
            </h1>
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <FadeIn>
              <p className="text-[#C8102E] text-xs font-black uppercase tracking-[0.25em] mb-3">Our Story</p>
              ...
              <p className="text-[#6B7280] leading-relaxed mb-5" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Red Ball Sports Arena was founded by <strong className="text-[#0D0D0D]">Sonu Malik</strong> with a single goal: to give the people of Rohtak access to world-class sports infrastructure — no compromises.
              </p>
              <p className="text-[#6B7280] leading-relaxed mb-5" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              ...
              <div className="flex items-center gap-4 mt-8 p-4 rounded-2xl bg-gray-50 border border-gray-100 w-fit">
                <div className="w-11 h-11 rounded-full bg-[#C8102E] flex items-center justify-center text-white font-black text-sm shrink-0" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>SM</div>
                <div>
                ...
                {TIMELINE.map((item, i) => (
                  <div key={i} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div className="w-2.5 h-2.5 rounded-full bg-[#C8102E] shrink-0 mt-1.5" />
                      {i < TIMELINE.length - 1 && <div className="w-px flex-1 bg-gray-200 mt-1" />}
                    </div>
                    <div className="pb-5">
                      <p className="text-[#C8102E] text-xs font-black uppercase tracking-widest mb-1" style={{ fontFamily: "'DM Sans', sans-serif" }}>{item.year}</p>
      ...
      <section className="bg-[#F9F6F1] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <FadeIn>
            <p className="text-[#C8102E] text-xs font-black uppercase tracking-[0.25em] mb-3">What We Offer</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {SPORTS.map((s, i) => (
              <FadeIn key={s.name} delay={i * 0.06}>
                <Link
                  to={s.link}
                  className="group block bg-white rounded-2xl p-6 border border-black/5 hover:border-[#C8102E]/20 hover:shadow-md transition-all duration-300 h-full"
                >
                  <div className="text-3xl mb-4">{s.icon}</div>
                  <h3 className="text-[#0D0D0D] font-black text-base mb-2 group-hover:text-[#C8102E] transition-colors" style={{ fontFamily: "'DM Sans', sans-serif" }}>{s.name}</h3>
                  <p className="text-[#6B7280] text-sm leading-relaxed" style={{ fontFamily: "'DM Sans', sans-serif" }}>{s.desc}</p>
                  <div className="flex items-center gap-1 mt-4 text-[#C8102E] text-xs font-bold">
      ...
      <section className="bg-[#0A0D0D] py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <FadeIn>
              <p className="text-[#C8102E] text-xs font-black uppercase tracking-[0.25em] mb-3">Cricket in Rohtak</p>
              ...
              <p className="text-white/55 leading-relaxed mb-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Red Ball Sports Arena is the official home ground of the <strong className="text-white">Rohtak Cricket League (RCL)</strong> — Rohtak's premier 20-over T20 competition featuring corporate and franchise teams from Rohtak, Haryana, and Delhi NCR.
              </p>
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-full bg-[#C8102E] text-white font-bold text-sm hover:bg-[#a60d25] transition-colors"
            ...
            <FadeIn delay={0.1}>
              <div className="rounded-2xl overflow-hidden border border-white/8">
                <img
                  ...
                  alt="Rohtak Cricket League at Red Ball Sports Arena"
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-8">
          <FadeIn>
            <p className="text-[#C8102E] text-xs font-black uppercase tracking-[0.25em] mb-3">Find Us</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { icon: <MapPin size={18} className="text-[#C8102E]" />, label: 'Address', value: 'Sector 22-D, Jhajjar Road, near Village-Maina, Rohtak, Haryana 124001' },
              { icon: <Clock size={18} className="text-[#C8102E]" />, label: 'Hours', value: academy.operatingHours },
              { icon: <Phone size={18} className="text-[#C8102E]" />, label: 'Phone', value: academy.phone },
              { icon: <Mail size={18} className="text-[#C8102E]" />, label: 'Email', value: academy.email },
            ].map((item, i) => (
          ...
          <FadeIn delay={0.2}>
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              <Link
                to="/book-slots"
                className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full bg-[#C8102E] text-white font-bold hover:bg-[#a60d25] transition-colors"
                style={{ fontFamily: "'DM Sans', sans-serif" }}
              >
